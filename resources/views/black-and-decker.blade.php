...
<head>
    ...
    <title>Taller de Herramientas Black & Decker - Ven a conocer todo el portafolio de
        Herramientas inambricas y eléctricas  línea de jardinería para uso ocasional.</title>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-center">
                <form action="{{ route('inscribe') }}" method="post"
                    ...
                    <input type="hidden" name="event_name" value="Black & Decker">
