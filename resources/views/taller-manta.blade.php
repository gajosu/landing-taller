...
<body class="bg-white text-white">
    ...
    <section class="h-screen relative">
        ...
        <div class="hidden md:block bg-cover h-full flex flex-col justify-end bg-bottom backgroundSlideDown"
            style="background-image: url('/images/taller-manta/banner.png'); animation-duration: 5s;"></div>

        <!-- Mobile Banner Image -->
        <div class="block md:hidden w-full h-full bg-cover flex flex-col justify-end bg-bottom backgroundSlideDown"
            style="background-image: url('/images/taller-manta/banner_mobile.png'); animation-duration: 5s;"></div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-around items-center text-center">
                ...
                <div class="flex flex-col items-center w-full md:w-1/4 mb-4 md:mb-0">
                    ...
                    <span>Universidad Laica Eloy Alfaro de Manabí - Auditorio de la Universidad de Arquitectura</span>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-center">
                <form action="{{ route('inscribe') }}" method="post"
                    ...
                    <input type="hidden" name="event_name" value="Taller Manta">
                    <input type="hidden" name="event_city" value="Manta">
                </form>
            </div>
        </div>
    </section>
