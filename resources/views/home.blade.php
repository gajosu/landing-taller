...
<head>
    ...
    <title>Centro de entrenamiento SBD<</title>
...
<body class="bg-white text-white">
    ...
    <section class="h-screen relative">
        ...
        <div class="hidden md:block bg-cover h-full flex flex-col justify-end bg-bottom backgroundSlideDown"
            style="background-image: url('/images/main/banner.webp'); animation-duration: 5s;"></div>

        <!-- Mobile Banner Image -->
        <div class="block md:hidden w-full h-full bg-cover flex flex-col justify-end bg-bottom backgroundSlideDown"
            style="background-image: url('/images/main/banner_mobile.webp'); animation-duration: 5s;"></div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-center">
                <form action="{{ route('inscribe') }}" method="post"
                    ...
                    <input type="hidden" name="event_name" value="SBD">
