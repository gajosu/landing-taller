            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type" id="type"
                        ...
                        <option value="promocion" {{ old('type') == 'promocion' ? 'selected' : '' }}>Promoción</option>
                    </select>
                    @error('type')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="file" name="banner_desktop" id="banner_desktop"
                           class="mt-1 block w-full file:mr-4 file:py-3 file:px-4 file:rounded-md file:border-2 file:border-gray-300 file:text-sm file:font-semibold file:bg-yellow-50 file:text-yellow-700 hover:file:bg-yellow-100"
                           required>
                ...
                <div>
                    ...
                    <input type="file" name="banner_mobile" id="banner_mobile"
                           class="mt-1 block w-full file:mr-4 file:py-3 file:px-4 file:rounded-md file:border-2 file:border-gray-300 file:text-sm file:font-semibold file:bg-yellow-50 file:text-yellow-700 hover:file:bg-yellow-100"
                           required>
                    @error('banner_mobile')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="mt-6 mb-6">
                    <div class="flex items-center">
                        <input type="checkbox" name="has_event" id="has_event" class="h-4 w-4 text-yellow-500 rounded border-gray-300">
                ...
                <div id="event_fields" class="hidden grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
