...
<head>
    ...
    <title>Taller gratuito - Herramientas manuales de medición y almacenamiento.<</title>
...
<body class="bg-white text-white">
    ...
    <section class="h-screen relative">
        ...
        <div class="hidden md:block bg-cover h-full flex flex-col justify-end bg-bottom backgroundSlideDown"
            style="background-image: url('/images/stanley31/banner.jpg'); animation-duration: 5s;"></div>

        <!-- Mobile Banner Image -->
        <div class="block md:hidden w-full h-full bg-cover flex flex-col justify-end bg-bottom backgroundSlideDown"
            style="background-image: url('/images/stanley31/banner_mobile.jpg'); animation-duration: 5s;"></div>
        ...
        <div class="w-full md:max-w-2xl absolute bottom-0">
            <div class="bg-gradient-to-r from-black to-transparent p-10 pb-20 md:p-10 fadeIn">
                ...
                <p class="text-2xl text-white mb-4 max-w-md fadeInUp" style="animation-delay: 1s;">
                    Ven y conoce toda la gama de herramientas de medición y la línea de almacenamiento
                </p>
                <button
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex justify-center">
                <form action="{{ route('inscribe') }}" method="post"
                    ...
                    <input type="hidden" name="event_name" value="Stanley Herramientas Medición y Almacenamiento"> 
